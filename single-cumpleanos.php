						...
						<section class="template-form py-4">
							<div class="row d-flex align-items-center">
											...
											<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
												<div class="card-body">
													<div class="form-row">
														...
														<div class="form-group col-12 col-lg-6">
															<label for="evento-input">Cumpleaños <b class="pink-dark-color">*</b></label>
															<input type="text" class="form-control form-control-sm" id="evento-input" value="5 Años">
														</div>
													</div>

													<div class="form-row">
														<div class="form-group col-12 col-lg-6">
															<label for="nombre-fiesta-input">Lugar del evento</label>
															<input type="text" class="form-control form-control-sm" id="nombre-fiesta-input" value="Lugar del Evento">
														</div>
														<div class="form-group col-12 col-lg-6">
														...
														<div class="form-group col-12 col-lg-6">
															...
															<div class="row">
																<div class="col-12 col-md-7">
																	<input type="time" class="form-control form-control-sm" id="hora-input" value="07:00">
																</div>
																<div class="col-12 col-md-5">
																	<!-- <label for="am-pm-fiesta-input">&nbsp;</label> -->
																	<select class="form-control form-control-sm" id="am-pm-input">
													...
													<div class="form-row">
														<div class="form-group col-12 col-lg-6">
															...
															<textarea class="form-control" id="texto-1-input" rows="2">Ven y celebra conmigo mis</textarea>
														</div>
														<div class="form-group col-12 col-lg-6">
															<label for="texto-2-input">Texto final</label>
															<textarea class="form-control" id="texto-2-input" rows="2">¡Te Esperamos!</textarea>
														</div>
													</div>
												</div>
											</div>
								...
								<div class="col-12 col-md-7 col-lg-6">
									...
									<div class="invitation-template-aspect-ratio" style="background-image: url('<?php echo esc_url(get_template_directory_uri()); ?>/plantillas/bg/cumpleanos/invitacion-cumpleanos-<?php the_field('numero_de_plantilla'); ?>.jpg'); background-size:100% 100%;" id="invitation-template-aspect-ratio">
										...
										<?php else: ?>
											<div class="invitation-frame-aspect-ratio" style="background-image: url('<?php echo esc_url(get_template_directory_uri()); ?>/plantillas/frame/cumpleanos/invitacion-cumpleanos-<?php the_field('numero_de_plantilla'); ?>.png'); background-size: 100% 100%;">
										<?php endif; ?>
											<div class="invitation-content-aspect-ratio">
												<div class="container text-center">
													<div class="row">
														<div class="col-12">
															<img src='<?php echo esc_url(get_template_directory_uri()); ?>/plantillas/icon/cumpleanos/invitacion-cumpleanos-<?php the_field('numero_de_plantilla'); ?>.png' class='img-fluid mb-2' alt='invitacion-cumpleanos' id="icono-field" width="<?php echo $iconoTamanoInicial; ?>" height="auto"><br>
															<p id="texto-1-field" class="plantillas-textos my-2">Ven y celebra conmigo mis</p>
															<p id="evento-field" class="title-font" style="color: <?php the_field('color_titulo'); ?>;">5 Años</p>
															<p id="nombre-field" class="title-font" style="color: <?php the_field('color_nombre'); ?>;">Nombre Apellido</p>
															<div class="row py-3">
																<div class="col-12">
																	<p class="plantillas-titulos" style="line-height: 2rem;"><span id="fecha-field">Sábado 4 de Enero</span><span class="px-3" style="font-size: 2rem;">|</span><span id="hora-field">7:00</span>&nbsp;<span id="am-pm-field">pm</span></p>
																</div>
															</div>
															<!-- <div class="row justify-content-center">
																<div class="col-6">
															...
															<p class="lead plantillas-titulos" id="nombre-fiesta-field"><b>Lugar del Evento</b></p>
															<p class="plantillas-textos" id="direccion-fiesta-field">Calle con número, Colonia y CP 00000. Municipio y Estado.</p><br>
															<p id="texto-2-field" class="plantillas-textos my-2">¡Te Esperamos!</p>
														</div>
													</div>
												</div>
											</div>
