						...
						<section class="template-form py-4">
							<div class="row d-flex align-items-center">
								...
								<div class="col-12 col-md-7 col-lg-6">
									...
									<div class="invitation-template-aspect-ratio" style="background-image: url('<?php echo esc_url(get_template_directory_uri()); ?>/plantillas/bg/baby-shower/invitacion-baby-shower-<?php the_field('numero_de_plantilla'); ?>.jpg'); background-size:100% 100%;" id="invitation-template-aspect-ratio">
										...
										<?php else: ?>
											<div class="invitation-frame-aspect-ratio" style="background-image: url('<?php echo esc_url(get_template_directory_uri()); ?>/plantillas/frame/baby-shower/invitacion-baby-shower-<?php the_field('numero_de_plantilla'); ?>.png'); background-size: 100% 100%;">
										<?php endif; ?>
											<div class="invitation-content-aspect-ratio">
												<div class="container text-center">
													<div class="row">
														<div class="col-12">
															<p id="evento-field" class="title-font" style="color: <?php the_field('color_titulo'); ?>;">Baby Shower</p>
															<p id="nombre-field" class="title-font" style="color: <?php the_field('color_nombre'); ?>;">Nombre Apellido</p>
															<img src='<?php echo esc_url(get_template_directory_uri()); ?>/plantillas/icon/baby-shower/invitacion-baby-shower-<?php the_field('numero_de_plantilla'); ?>.png' class='img-fluid mb-2' alt='invitacion-baby-shower' id="icono-field" width="<?php echo $iconoTamanoInicial; ?>" height="auto"><br>
															<div class="row py-3">
																<div class="col-12">
